...
_REQUESTER = connection.c error.c message.c other.c
REQUESTER = $(patsubst %,$(IDIR)/%,$(_REQUESTER))

_WORKER = connection.c error.c message.c other.c crypt.c
WORKER = $(patsubst %,$(IDIR)/%,$(_WORKER))

_SERVER = connection.c error.c message.c other.c crypt.c object.c structure.c
